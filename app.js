...
const categoryMeta = {
  ...
  翻译出海: { icon: "译", label: "翻译出海" },
  办公会议: { icon: "会", label: "办公会议" },
  知识库RAG: { icon: "库", label: "知识库RAG" },
  "3D游戏": { icon: "3D", label: "3D游戏" },
  浏览器插件: { icon: "插", label: "浏览器插件" },
  医疗健康: { icon: "医", label: "医疗健康" },
  金融投资: { icon: "金", label: "金融投资" },
  内容运营: { icon: "内", label: "内容运营" },
  Logo品牌: { icon: "标", label: "Logo品牌" },
  开发平台: { icon: "云", label: "开发平台" },
};
...
const expansionGroups = [
  ...
  },
  {
    ...
    items: [
      ["iAsk", "iask.ai"],
      ["Tavily", "tavily.com", { capabilities: ["api"] }],
      ["Linkup", "linkup.so", { capabilities: ["api"] }],
      ["Kagi Assistant", "kagi.com"],
      ["Arc Search", "arc.net"],
      ["Scira", "scira.ai"],
      ["Globe Explorer", "explorer.globe.engineer"],
      ["ThinkAny", "thinkany.ai"],
      ["Devv", "devv.ai"],
      ["Bagoodex", "bagoodex.io"],
      ["OpenPerplex", "openperplex.com"],
      ["Perplexica", "github.com", { capabilities: ["local"], url: "https://github.com/ItzCrazyKns/Perplexica" }],
  ...
  },
  {
    ...
    items: [
      ...
      ["DreamStudio", "dreamstudio.ai", { capabilities: ["api"] }],
  ...
  },
  {
    ...
    items: [
      ...
      ["Runway Act-One", "runwayml.com"],
      ["Hedra", "hedra.com"],
      ["Vizard", "vizard.ai"],
      ["Vmaker AI", "vmaker.com"],
      ["Wisecut", "wisecut.video"],
    ],
  },
  {
    category: "编程开发",
    ...
    items: [
      ...
      ["Bito", "bito.ai"],
      ["Cline", "cline.bot", { capabilities: ["local"] }],
      ["Roo Code", "roocode.com", { capabilities: ["local"] }],
      ...
      ["Pieces", "pieces.app"],
      ["Zed AI", "zed.dev"],
      ["Phind Code", "phind.com"],
      ["Codiga", "codiga.io"],
      ["CodeWhisperer", "aws.amazon.com"],
      ["Smol Developer", "github.com", { capabilities: ["local"], url: "https://github.com/smol-ai/developer" }],
      ["OpenDevin", "github.com", { capabilities: ["local"], url: "https://github.com/OpenDevin/OpenDevin" }],
      ["SWE-agent", "swe-agent.com", { capabilities: ["local"] }],
    ],
  },
  {
    category: "自动化智能体",
    ...
    items: [
      ...
      ["Dust", "dust.tt"],
      ["E2B", "e2b.dev", { capabilities: ["api"] }],
      ["Langbase", "langbase.com", { capabilities: ["api"] }],
      ["VectorShift", "vectorshift.ai"],
      ["Respell", "respell.ai"],
      ["Cassidy", "cassidyai.com"],
      ["Bardeen", "bardeen.ai"],
      ["Relay.app", "relay.app"],
      ["Zapier Central", "zapier.com"],
      ["AirOps", "airops.com"],
      ["Pipedream AI", "pipedream.com"],
    ],
  },
  {
    category: "学术研究",
    ...
    items: [
      ...
      ["Typeset", "typeset.io"],
      ["Avidnote", "avidnote.com"],
      ["ScholarAI", "scholarai.io"],
      ["Paper Digest", "paperdigest.org"],
      ["Inciteful", "inciteful.xyz"],
      ["OpenRead", "openread.academy"],
    ],
  },
  {
    category: "本地开源",
    ...
    items: [
      ...
      ["LocalAI", "localai.io"],
      ["Tabby", "tabbyml.com"],
      ["Text Generation WebUI", "github.com", { url: "https://github.com/oobabooga/text-generation-webui" }],
      ["llamafile", "github.com", { url: "https://github.com/Mozilla-Ocho/llamafile" }],
      ["GPT Pilot", "github.com", { url: "https://github.com/Pythagora-io/gpt-pilot" }],
      ["Open Interpreter", "openinterpreter.com"],
      ["Khoj", "khoj.dev"],
      ["Danswer", "danswer.ai"],
      ["Flowise Local", "flowiseai.com"],
      ["Qdrant", "qdrant.tech", { capabilities: ["api", "local"] }],
      ["Weaviate", "weaviate.io", { capabilities: ["api", "local"] }],
      ["Milvus", "milvus.io", { capabilities: ["api", "local"] }],
      ["Chroma", "trychroma.com", { capabilities: ["api", "local"] }],
    ],
  },
  {
    category: "音频语音",
    ...
    items: [
      ...
      ["Voice.ai", "voice.ai"],
      ["ElevenLabs Dubbing", "elevenlabs.io"],
      ["Kits AI", "kits.ai"],
  ...
  },
  {
    ...
    items: [
      ...
      ["Baseten", "baseten.co"],
      ["Anyscale Endpoints", "anyscale.com"],
  ...
  {
    category: "提示词资源",
    scenarios: ["research", "design"],
    capabilities: ["mobile"],
    score: 74,
    tags: ["提示词", "模板", "社区"],
    items: [
      ["PromptBase", "promptbase.com"],
      ["PromptLayer", "promptlayer.com", { capabilities: ["api", "team"] }],
      ["Promptfoo", "promptfoo.dev", { capabilities: ["api", "local"] }],
      ["PromptPerfect", "promptperfect.jina.ai"],
      ["ChainForge", "chainforge.ai", { capabilities: ["local"] }],
      ["God of Prompt", "godofprompt.ai"],
      ["Learn Prompting", "learnprompting.org"],
      ["PromptHub", "prompthub.us"],
      ["Promptmetheus", "promptmetheus.com"],
      ["Parea AI", "parea.ai", { capabilities: ["api", "team"] }],
      ["Agenta", "agenta.ai", { capabilities: ["api", "team"] }],
      ["Humanloop", "humanloop.com", { capabilities: ["api", "team"] }],
    ],
  },
  {
    category: "学习教育",
  ...
  {
    category: "数据分析",
    scenarios: ["research", "ecommerce"],
    capabilities: ["team"],
    score: 78,
    tags: ["数据", "图表", "分析"],
    items: [
      ["ThoughtSpot Sage", "thoughtspot.com"],
      ["Formula Bot", "formulabot.com"],
      ["SheetAI", "sheetai.app"],
      ["Equals AI", "equals.com"],
      ["DataChat", "datachat.ai"],
      ["Databricks Assistant", "databricks.com"],
      ["Hex Magic", "hex.tech"],
      ["Mode AI", "mode.com"],
      ["Deepnote AI", "deepnote.com"],
      ["Google Colab AI", "colab.research.google.com"],
      ["Quadratic", "quadratic.to"],
      ["Obviously AI", "obviously.ai"],
      ["Mito", "trymito.io"],
      ["Ajelix", "ajelix.com"],
      ["Numerous.ai", "numerous.ai"],
      ["Arcwise", "arcwise.app"],
    ],
  },
  {
    ...
    items: [
      ...
      ["Carrd", "carrd.co"],
      ["10Web", "10web.io"],
      ["Hostinger AI Website Builder", "hostinger.com"],
  ...
  },
  {
    ...
    items: [
      ...
      ["Omneky", "omneky.com"],
      ["Smartly.io AI", "smartly.io"],
      ["Persado", "persado.com"],
      ["Phrasee", "phrasee.co"],
      ["Mutiny", "mutinyhq.com"],
      ["Klaviyo AI", "klaviyo.com"],
      ["Tidio AI", "tidio.com"],
      ["Manychat AI", "manychat.com"],
      ["Jasper Campaigns", "jasper.ai"],
      ["Anyword Ads", "anyword.com"],
      ["AdCopy", "adcopy.ai"],
      ["Madgicx", "madgicx.com"],
      ["Ocoya", "ocoya.com"],
      ["Predis.ai", "predis.ai"],
      ["CreatorKit", "creatorkit.com"],
    ],
  },
  {
    category: "数字人",
    ...
    tags: ["数字人", "口播", "虚拟人"],
    items: [
      ["Tavus", "tavus.io", { capabilities: ["api", "team"] }],
      ["Soul Machines", "soulmachines.com"],
      ["Inworld AI", "inworld.ai", { capabilities: ["api", "team"] }],
      ["Ready Player Me", "readyplayer.me"],
      ["Hour One", "hourone.ai"],
      ["DeepBrain AI", "deepbrain.io"],
      ["Synthesys", "synthesys.io"],
      ["Yepic AI", "yepic.ai"],
      ["HeyGen Translate", "heygen.com"],
      ["D-ID Agents", "d-id.com"],
      ["Colossyan Creator", "colossyan.com"],
      ["Vidnoz AI", "vidnoz.com"],
    ],
  },
  {
    category: "AI检测评测",
    scenarios: ["paper", "code"],
    capabilities: ["api", "team"],
    score: 77,
    tags: ["检测", "评测", "质量"],
    items: [
      ...
      ["Sapling AI Detector", "sapling.ai"],
      ["Writer AI Detector", "writer.com"],
      ["Content at Scale Detector", "contentatscale.ai"],
      ["GLTR", "gltr.io"],
      ["AI Text Classifier", "platform.openai.com"],
      ["Langfuse", "langfuse.com", { capabilities: ["api", "local"] }],
      ["Arize Phoenix", "phoenix.arize.com", { capabilities: ["api", "local"] }],
      ["TruLens", "trulens.org", { capabilities: ["api", "local"] }],
  ...
  },
  {
    ...
    tags: ["法律", "合同", "财税"],
    items: [
      ["CoCounsel", "casetext.com"],
      ["Lexion", "lexion.ai"],
      ["Ironclad AI", "ironcladapp.com"],
      ["Robin AI", "robinai.com"],
      ["Klarity", "klaritylaw.com"],
      ["TaxGPT", "taxgpt.com"],
      ["Vic.ai", "vic.ai"],
      ["Ramp Intelligence", "ramp.com"],
      ["Brex AI", "brex.com"],
      ["Fiscal.ai", "fiscal.ai"],
      ["Legora", "legora.com"],
  ...
  {
    category: "翻译出海",
    scenarios: ["paper", "video", "ecommerce"],
    capabilities: ["api", "team"],
    score: 79,
    tags: ["翻译", "本地化", "出海"],
    items: [
      ...
      ["MateCat", "matecat.com"],
      ["Lokalise AI", "lokalise.com"],
      ["Phrase", "phrase.com"],
      ["Smartcat", "smartcat.com"],
      ["Weglot", "weglot.com"],
      ["Crowdin", "crowdin.com"],
      ["Rask AI", "rask.ai"],
      ["Dubverse", "dubverse.ai"],
      ["Vidby", "vidby.com"],
      ["Transifex AI", "transifex.com"],
      ["Immersive Translate", "immersivetranslate.com"],
    ],
  },
  {
    category: "办公会议",
    scenarios: ["slides", "research"],
    capabilities: ["team"],
    score: 78,
    tags: ["会议", "纪要", "办公"],
    items: [
      ...
      ["Teams Copilot", "microsoft.com"],
      ["Google Meet Gemini", "workspace.google.com"],
      ["Noty.ai", "noty.ai"],
  ...
  },
  {
    ...
    items: [
      ...
      ["MyMind", "mymind.com"],
      ["Klu", "klu.ai"],
      ["LlamaIndex", "llamaindex.ai", { capabilities: ["api", "local"] }],
      ["Haystack", "haystack.deepset.ai", { capabilities: ["api", "local"] }],
      ["Vespa", "vespa.ai", { capabilities: ["api", "local"] }],
      ["Vectara", "vectara.com", { capabilities: ["api", "team"] }],
      ["Pinecone", "pinecone.io", { capabilities: ["api", "team"] }],
      ["Dify Knowledge", "dify.ai"],
      ["AnythingLLM Workspace", "anythingllm.com"],
    ],
  },
  {
    category: "3D游戏",
    ...
    items: [
      ...
      ["CSM", "csm.ai"],
      ["Polycam", "poly.cam"],
      ["Masterpiece X", "masterpiecex.com"],
      ["Spline AI", "spline.design"],
      ["Leonardo 3D Texture", "leonardo.ai"],
      ["Scenario GenAI", "scenario.com"],
      ["Inworld Studio", "inworld.ai"],
    ],
  },
  {
    category: "浏览器插件",
    ...
    items: [
      ...
      ["Glarity", "glarity.app"],
      ["ReaderGPT", "readergpt.ai"],
      ["WebChatGPT", "webchatgpt.app"],
      ...
      ["Compose AI", "compose.ai"],
      ["MaxAI", "maxai.me"],
      ["ChatGPT Sidebar", "chatgpt-sidebar.com"],
      ["Wiseone", "wiseone.io"],
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      ["Kensho", "kensho.com"],
      ["Numerai", "numer.ai"],
      ["PortfolioPilot", "portfoliopilot.com"],
      ["TipRanks AI", "tipranks.com"],
      ["Koyfin", "koyfin.com"],
      ["Sentieo", "sentieo.com"],
      ["Fiscal.ai", "fiscal.ai"],
      ["Bloomberg Terminal AI", "bloomberg.com"],
    ],
  },
  {
    category: "内容运营",
    scenarios: ["ecommerce", "video"],
    capabilities: ["team"],
    score: 76,
    tags: ["内容", "社媒", "运营"],
    items: [
      ["Buffer AI", "buffer.com"],
      ["OwlyWriter AI", "hootsuite.com"],
      ["Sprout Social AI", "sproutsocial.com"],
      ["Later AI", "later.com"],
      ["FeedHive", "feedhive.com"],
      ["Taplio", "taplio.com"],
      ["Typefully", "typefully.com"],
      ["Tweet Hunter", "tweethunter.io"],
      ["Metricool AI", "metricool.com"],
  ...
  },
  {
    ...
    items: [
      ...
      ["Namelix", "namelix.com"],
      ["BrandCrowd", "brandcrowd.com"],
      ["Hatchful", "shopify.com"],
      ["Logomaster", "logomaster.ai"],
      ["Looka", "looka.com"],
      ["Kittl AI", "kittl.com"],
      ["Recraft", "recraft.ai"],
  ...
  },
  {
    ...
    items: [
      ...
      ["Cloudflare AI", "developers.cloudflare.com"],
      ["Supabase AI", "supabase.com"],
      ["Firebase Genkit", "firebase.google.com"],
      ["Convex AI", "convex.dev"],
      ["Railway", "railway.app"],
      ["Render", "render.com"],
      ["Fly.io", "fly.io"],
      ["Neon", "neon.tech"],
      ...
      ["E2B Sandbox", "e2b.dev"],
      ["LangChain Platform", "langchain.com"],
      ["LlamaCloud", "llamaindex.ai"],
    ],
  },
];

function createExpansionTool(group, item, index) {
  const [name, domain, overrides = {}] = item;
  const capabilities = overrides.capabilities || group.capabilities || ["mobile"];
  const scenarios = overrides.scenarios || group.scenarios || ["research"];
  const score = overrides.score || Math.max(68, (group.score || 75) - Math.floor(index / 16));
  return createSeedTool([
    name,
    domain,
    overrides.category || group.category,
    overrides.price || group.price || "freemium",
    overrides.region || group.region || "海外",
    capabilities,
    scenarios,
    score,
    overrides.tags || group.tags || [],
    overrides.url,
  ]);
}

function createExpansionTools(groups) {
  return groups.flatMap((group) => group.items.map((item, index) => createExpansionTool(group, item, index)));
}

function catalogKey(tool) {
  return String(tool.name).trim().toLowerCase().replace(/\s+/g, " ");
}
...
const tools = uniqueTools([...coreTools, ...toolSeedRows.map(createSeedTool), ...createExpansionTools(expansionGroups)]);
